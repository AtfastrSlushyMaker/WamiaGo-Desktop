...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            User newUser = new User(1, "John Doe", "john@example.com", "15678", "securepassword",
            ...
            Driver driver = new Driver(
                    1, newUser.getId(), "John Doe", "john@example.com", "15678",
                    "securepassword", Driver.DriverRole.TAXI_DRIVER, location, "A1B2C3D4",
                    Driver.DRIVER_ACTIVE, User.Gender.MALE, "john_profile.jpg", true,
                    User.AccountStatus.ACTIVE, LocalDate.of(1990, 5, 15), User.Status.OFFLINE
            );
            ...
            List<User> sortedByName = userService.sortUsers("name", true);
            sortedByName.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("###Users sorted by date of birth###");
            System.out.println("### =========================== ###");

            List<User> sortedByDob = userService.sortUsers("dateOfBirth", true);
            ...
            List<User> sortedByEmail = userService.sortUsers("email", true);
            sortedByEmail.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("###     Users sorted by role    ###");
            System.out.println("### =========================== ###");

            List<User> sortedByRole = userService.sortUsers("role", true);
            sortedByRole.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("###     Users sorted by gender  ###");
            System.out.println("### =========================== ###");

            List<User> sortedByGender = userService.sortUsers("gender", true);
            sortedByGender.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("###Users sorted by account status###");
            System.out.println("### =========================== ###");

            List<User> sortedByAccountStatus = userService.sortUsers("accountStatus", true);
            sortedByAccountStatus.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("### Users sorted by status      ###");
            System.out.println("### =========================== ###");

            List<User> sortedByStatus = userService.sortUsers("status", true);
            sortedByStatus.forEach(System.out::println);

            System.out.println("### =========================== ###");
            System.out.println("### Users sorted by location    ###");
            System.out.println("### =========================== ###");

            List<User> sortedByLocation = userService.sortUsers("location", true);
            sortedByLocation.forEach(System.out::println);
            ...
            System.out.println("### =========================== ###");
            System.out.println("###  Updated User and Driver    ###");
            System.out.println("### =========================== ###");
