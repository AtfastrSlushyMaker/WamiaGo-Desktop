...
public class DashboardTemplateController implements Initializable {
    ...
    private void loadPanels() {
        try {
            ...
            //1
            AnchorPane bikesPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //2
            AnchorPane stationsPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //3
            AnchorPane rentalsPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //4
            AnchorPane requestsPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //5
            AnchorPane ridesPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //6
            AnchorPane responsesPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Relocation/Front/Relocations.fxml")));
            //7
            AnchorPane announcementsPanel = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Annoucement/Front/announcementAdmin.fxml")));    ;
            //8
            ...
            //10
            AnchorPane statisticsPanel= FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/Statistics.Front/Statistics.fxml")));
